...
public class LevelParser : MonoBehaviour
{
    ...
    void LoadLevel()
    {
        ...
        while (levelRows.Count > 0)
        {
            ...
            {
                // Todone - Instantiate a new GameObject that matches the type specified by letter
                // Todone - Position the new GameObject at the appropriate location by using row and column
                // Todone - Parent the new GameObject under levelRoot

                switch (letters[col])
                {
                    case 'x':
                        GameObject newObjX = Instantiate(rockPrefab, environmentRoot);
                        newObjX.transform.position = new Vector3(col + 0.5f, row + 0.5f, 0f);
                        break;
                    case '?':
                        GameObject newObjQ = Instantiate(questionBoxPrefab, environmentRoot);
                        newObjQ.transform.position = new Vector3(col + 0.5f, row + 0.5f, 0f);
                        break;
                    case 'b':
                        GameObject newObjB = Instantiate(brickPrefab, environmentRoot);
                        newObjB.transform.position = new Vector3(col + 0.5f, row + 0.5f, 0f);
                        break;
                    case 's':
                        GameObject newObjS = Instantiate(stonePrefab, environmentRoot);
                        newObjS.transform.position = new Vector3(col + 0.5f, row + 0.5f, 0f);
                        break;
                    case 'l':
                        GameObject newObjL = Instantiate(lavaPrefab, environmentRoot);
                        newObjL.transform.position = new Vector3(col + 0.5f, row + 0.5f, 0f);
                        break;
                    case 'g':
                        GameObject newObjG = Instantiate(goalPrefab, environmentRoot);
                        newObjG.transform.position = new Vector3(col + 0.5f, row + 0.5f, 0f);
                        break;
                    default:
                        break;
                }
